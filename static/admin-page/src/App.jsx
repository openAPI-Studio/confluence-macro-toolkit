...
const MACROS = [
  ...
  { key: 'carousel-slideshow', name: 'Carousel / Slideshow', description: 'Display images in an interactive slideshow', defaultEnabled: true, icon: '<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect x="3" y="5" width="18" height="14" rx="2" fill="#E9F2FF" stroke="#0052CC" stroke-width="1.5"/><circle cx="8" cy="16" r="1" fill="#0052CC"/><circle cx="12" cy="16" r="1" fill="#0052CC"/><circle cx="16" cy="16" r="1" fill="#ccc"/><path d="M7,12 L10,9 L13,11 L16,8 L19,11" stroke="#0052CC" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>' },
];
