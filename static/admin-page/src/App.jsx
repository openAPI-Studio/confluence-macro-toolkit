...
const MACROS = [
  ...
  { key: 'typewriter-macro', name: 'Typewriter', description: 'Animate text with typewriter/chat-style effects', defaultEnabled: true, icon: '<svg width="24" height="24" viewBox="0 0 59 59" xmlns="http://www.w3.org/2000/svg"><rect x="12" y="0.5" style="fill:#E6E6E6;" width="35" height="26"/><path style="fill:#6C797A;" d="M35,15.5H17c-0.552,0-1-0.447-1-1s0.448-1,1-1h18c0.552,0,1,0.447,1,1S35.552,15.5,35,15.5z"/><path style="fill:#6C797A;" d="M23,19.5h-6c-0.552,0-1-0.447-1-1s0.448-1,1-1h6c0.552,0,1,0.447,1,1S23.552,19.5,23,19.5z"/><path style="fill:#6C797A;" d="M39,19.5h-6c-0.552,0-1-0.447-1-1s0.448-1,1-1h6c0.552,0,1,0.447,1,1S39.552,19.5,39,19.5z"/><path style="fill:#6C797A;" d="M33,23.5H22c-0.552,0-1-0.447-1-1s0.448-1,1-1h11c0.552,0,1,0.447,1,1S33.552,23.5,33,23.5z"/><rect x="6" y="51.5" style="fill:#47A083;" width="48" height="4"/><rect x="8" y="55.5" style="fill:#38454F;" width="6" height="3"/><rect x="46" y="55.5" style="fill:#38454F;" width="6" height="3"/><path style="fill:#71C3A9;" d="M52,31.5H8v11c0,3.55-0.775,6.729-2,8.926V51.5h48v-0.074c-1.225-2.197-2-5.377-2-8.926V31.5z"/><polygon style="fill:#434C6D;" points="5,26.5 5,34.5 8,34.5 8,31.5 52,31.5 52,34.5 52,34.5 52,26.5"/><path style="fill:#38454F;" d="M57.678,34.5H52V23.822c0-0.73,0.592-1.322,1.322-1.322h4.356c0.73,0,1.322,0.592,1.322,1.322v9.356C59,33.908,58.408,34.5,57.678,34.5z"/><rect x="52" y="25.5" style="fill:#546A79;" width="7" height="2"/><rect x="52" y="29.5" style="fill:#546A79;" width="7" height="2"/><path style="fill:#CBD4D8;" d="M5,29.5H2v-7h3c0.552,0,1-0.447,1-1s-0.448-1-1-1H0v11h5V29.5z"/></svg>' },
  {
    key: 'plantuml-macro',
    name: 'PlantUML',
    description: 'Render UML diagrams from PlantUML syntax',
    defaultEnabled: false,
            ...
            <div style={{ flex: 1, overflow: 'auto', padding: '0 16px 16px' }}>
              ...
              {(libCatalog || []).filter((l) => l.name.toLowerCase().includes(libSearch.toLowerCase()) || l.description?.toLowerCase().includes(libSearch.toLowerCase())).map((lib) => (
                <div key={lib.id} style={{ padding: '10px 0', borderBottom: '1px solid #f0f0f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <button onClick={() => addFromCatalog(lib)} disabled={addingLib === lib.id} style={{ padding: '4px 10px', fontSize: 11, border: `1px solid ${addedLibs.has(lib.id) ? '#36B37E' : '#0052CC'}`, borderRadius: 3, background: addingLib === lib.id ? '#eee' : '#fff', color: addedLibs.has(lib.id) ? '#36B37E' : '#0052CC', cursor: 'pointer', whiteSpace: 'nowrap' }}>
                    {addingLib === lib.id ? 'Adding...' : addedLibs.has(lib.id) ? '✓ Added' : '+ Add'}
                  </button>
                </div>
              ))}
            </div>
